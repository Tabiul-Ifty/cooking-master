...
const displayFoods = (foods) => {
  ...
  allMeals.innerHTML = "";
  const mealIfoDiv = document.getElementById("mealDetails");
...
const renderMealInfo = (meal) => {
  const mealIfoDiv = document.getElementById("mealDetails");
  mealIfoDiv.innerHTML = `<div class="row row-cols-2 row-cols-md-9 g-4 justify-content-center text-center">
                        <div class="col">
